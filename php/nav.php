<nav class="d-inline-block position-relative" style="background-color: #FAFFC1; height: 100vh; width: 250px;">
            ...
            <ul class="list-unstyled mt-5 mx-auto text-center w-75">
                <li class="mt-3 mx-auto w-75"><a class="d-block rounded py-2 fw-bold text-dark text-decoration-none" href="dashboard.php"><ion-icon name="home-outline"></ion-icon> Home</a></li>
                ...
                <li class="mt-3 mx-auto w-75"><a class="d-block rounded py-2 fw-bold text-dark text-decoration-none" href="students.php"><ion-icon name="people-outline"></ion-icon> Students</a></li>
                <li class="mt-3 mx-auto w-75"><a class="d-block rounded py-2 fw-bold text-dark text-decoration-none" href="payment.php"><ion-icon name="card-outline"></ion-icon> Payment</a></li>
